...
using HireConnect.Application.Middleware;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version     = "v1",
        Description = "Manages job application submission, status tracking, and withdrawal."
    });
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "HireConnect Application Service v1");
